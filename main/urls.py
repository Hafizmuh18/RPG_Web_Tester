...
from .views import delete_item_ajax, add_product_ajax, get_product_json, test_page, logout_user ,login_user, register, view_json_id, view_json_user, view_xml_id, view_json, view_xml, char_desc, display_main, add_item, remove_item
...
urlpatterns = [
    ...
    path('json-user/', view_json_user, name='view_json_user'),
